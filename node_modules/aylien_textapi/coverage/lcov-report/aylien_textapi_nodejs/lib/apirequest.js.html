...
<html lang="en">
<head>
    <title>Code coverage report for aylien_textapi_nodejs/lib/apirequest.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">aylien_textapi_nodejs/lib/apirequest.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">aylien_textapi_nodejs/lib/</a> &#187; apirequest.js</div>
</div>
<div class="body">
    ...
    response.on('end', function() {
      ...
      if (response.statusCode == 200) {
        ...
        try {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (tmp.error) { errorString = tmp.error; }
        } catch(e) {}
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Feb 09 2015 12:24:11 GMT+0000 (GMT)</div>
</div>
