...
<html lang="en">
<head>
    <title>Code coverage report for aylien_textapi_nodejs/textapi.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">aylien_textapi_nodejs/textapi.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">aylien_textapi_nodejs/</a> &#187; textapi.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  this.summarize = function(params, callback) {
    ...
    if (!params.url &amp;&amp; (!params.text || <span class="branch-2 cbranch-no" title="branch not covered" >!params.title)</span>) {
